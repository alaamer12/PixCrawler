...
def test_files_dir(temp_storage_dir: Path) -> Path:
    ...
    Args:
        temp_storage_dir: Temporary storage directory from conftest.py
...
class TestStorageFactory:
    ...
    def test_create_local_provider_from_settings(self, storage_settings: StorageSettings):
    ...
    def test_get_storage_provider_convenience_function(self, storage_settings: StorageSettings):
        """Test get_storage_provider convenience function."""
        provider = get_storage_provider(storage_settings)
...
class TestEndToEndWorkflows:
    ...
    def test_complete_dataset_workflow(self, storage_settings: StorageSettings, test_files_dir: Path, temp_storage_dir: Path):
    ...
    def test_multi_project_isolation(self, storage_settings: StorageSettings, test_files_dir: Path):
    ...
    def test_backup_and_restore_workflow(self, storage_settings: StorageSettings, test_files_dir: Path, temp_storage_dir: Path):
    ...
    def test_versioning_workflow(self, storage_settings: StorageSettings, test_files_dir: Path):
...
class TestErrorRecovery:
    ...
    def test_recovery_from_partial_upload(self, storage_settings: StorageSettings, test_files_dir: Path):
    ...
    def test_graceful_handling_of_missing_files(self, storage_settings: StorageSettings):
    ...
    def test_handling_of_corrupted_operations(self, storage_settings: StorageSettings, test_files_dir: Path):
...
class TestPerformanceAndConcurrency:
    ...
    def test_large_file_operations(self, storage_settings: StorageSettings, temp_storage_dir: Path):
    ...
    def test_many_small_files(self, storage_settings: StorageSettings, test_files_dir: Path):
    ...
    def test_sequential_operations_performance(self, storage_settings: StorageSettings, test_files_dir: Path, temp_storage_dir: Path):
    ...
    def test_list_files_with_large_directory(self, storage_settings: StorageSettings, test_files_dir: Path):
...
class TestRealWorldScenarios:
    ...
    def test_image_dataset_management(self, storage_settings: StorageSettings, test_files_dir: Path):
    ...
    def test_temporary_file_cleanup(self, storage_settings: StorageSettings, test_files_dir: Path):
    ...
    def test_user_quota_simulation(self, storage_settings: StorageSettings, test_files_dir: Path):
