...
- [ ] 1. Phase 1: Testing Infrastructure & Critical Import Fixes
  - Set up architecture compliance testing framework
  - Fix HTTP status code import collisions across all endpoint files
  - Fix Dataset model index definitions
  - _Requirements: 1.1, 1.2, 1.3, 1.4, 4.1, 4.2, 4.3, 4.4, 13.1, 13.2, 13.3, 13.4_

- [ ] 1.1 Create architecture test utilities
  - Write helper functions for scanning Python files
  - Create AST parsing utilities for code analysis
  - Implement pattern matching for forbidden imports
  - Set up Hypothesis for property-based testing
  - Configure test coverage reporting
  - _Requirements: 13.1, 13.2, 13.3, 13.4_

- [ ] 1.2 Write architecture compliance tests
  - Test: Services don't import AsyncSession directly
  - Test: Repositories extend BaseRepository
  - Test: Endpoints don't execute database queries
  - Test: Endpoints use http_status alias
  - _Requirements: 13.1, 13.2, 13.3, 13.4_
...
- [ ] 2. Phase 2: Service Layer Architecture & PolicyService Implementation
...
- [ ] 2.1 Implement PolicyService class
...
- [ ] 2.2 Create PolicyService dependency injection
...
- [ ] 2.5 Fix notification service repository calls
...
- [ ]* 2.10 Write property test for repository update signature
  - **Property 3: Repository Update Method Signature**
  - **Validates: Requirements 2.2**

- [ ]* 2.11 Write property test for repository get method naming
...
- [ ] 3.2 Replace crawling implementation with builder delegation
