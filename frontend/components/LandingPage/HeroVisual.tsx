...
import { Search, Database, CheckCircle2, Loader2, Check } from 'lucide-react'
				...
				<div className="p-6  md:p-8 space-y-6 flex-1 overflow-hidden">
					...
					<div className="space-y-3">
						<div className="relative">
							...
							/>
							<div className="absolute right-2 top-1/2 -translate-y-1/2 px-4 py-1.5 bg-primary text-primary-foreground text-sm font-medium rounded-md flex items-center gap-2">
					...
					{/* Process flow */}
					<div className="flex items-center py-4 relative transition-opacity duration-400" style={{ opacity: isResetting ? 0.3 : 1 }}>
						{steps.map((step, i) => (
