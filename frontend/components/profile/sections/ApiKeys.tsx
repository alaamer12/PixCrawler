          ...
          <div className="flex gap-3">
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm text-blue-800 dark:text-blue-200">
                Never share your API keys publicly. Rotate keys regularly and use environment variables to store them securely.
              </p>
            </div>
          </div>
        </CardContent>
        ...
        <DialogContent className="max-w-4xl max-h-[85vh] p-0 gap-0">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <DialogDescription className="mt-1">
                    Configure access permissions for <span className="font-semibold text-foreground">"{editingKey?.name}"</span>
                  </DialogDescription>
                </div>
              </div>
            </DialogHeader>
          ...
          <div className="overflow-y-auto max-h-[calc(85vh-200px)] px-8 py-6">
            <div className="space-y-8">
              ...
              <div className="flex items-center justify-between p-4 bg-gradient-to-br from-muted/50 to-muted rounded-xl border shadow-sm">
                <div className="flex items-center gap-3">
              ...
              {editPermissions.includes('admin:all') && (
                <div className="flex items-start gap-3 p-4 bg-gradient-to-r from-destructive/10 to-destructive/5 border-2 border-destructive/30 rounded-xl shadow-sm">
