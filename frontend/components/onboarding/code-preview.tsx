...
export function CodePreview({config}: CodePreviewProps) {
  ...
  return (
    <div className="bg-card border border-border rounded-xl shadow-lg overflow-hidden">
      <div className="relative px-6 py-4 border-b border-border/50 bg-gradient-to-r from-background via-primary/5 to-background overflow-hidden">
        ...
        <div className="relative flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="relative">
              ...
              <div className="relative size-8 rounded-lg bg-gradient-to-br from-primary/20 to-purple-500/20 border border-primary/30 flex items-center justify-center">
          ...
          <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-gradient-to-r from-primary/10 via-purple-500/10 to-primary/10 border border-primary/20 backdrop-blur-sm">
            <div className="size-1.5 bg-emerald-500 rounded-full animate-pulse" />
            <span className="text-xs font-semibold">Building</span>
            <span className="text-xs font-bold bg-gradient-to-r from-primary via-purple-500 to-primary bg-clip-text text-transparent">
              animals dataset
            </span>
          </div>
        </div>
