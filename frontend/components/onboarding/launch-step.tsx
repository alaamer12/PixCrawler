...
export function LaunchStep({config, onLaunch, onBack}: LaunchStepProps) {
  ...
  return (
    <div className="space-y-8">
      {/* Summary Card */}
      <div className="relative bg-card border border-border rounded-xl shadow-2xl p-8 text-center space-y-6 overflow-hidden group">
        {/* Animated shine border */}
        <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-transparent via-primary/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 animate-shimmer" />
        <div className="absolute inset-0 rounded-xl border-2 border-transparent bg-gradient-to-r from-primary/20 via-purple-500/20 to-primary/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300" style={{WebkitMask: 'linear-gradient(#fff 0 0) content-box, linear-gradient(#fff 0 0)', WebkitMaskComposite: 'xor', maskComposite: 'exclude', padding: '2px'}} />
        ...
        <div className="relative flex justify-center">
          <div className="relative">
            ...
            <div className="relative w-20 h-20 bg-gradient-to-br from-primary/20 via-purple-500/20 to-primary/20 rounded-full flex items-center justify-center border-2 border-primary/30 shadow-lg shadow-primary/20">
        ...
        <div className="relative bg-gradient-to-br from-muted/50 to-muted/30 border border-border/50 rounded-xl p-6 text-left max-w-md mx-auto backdrop-blur-sm shadow-inner">
          <div className="space-y-3">
            <div className="flex justify-between items-center py-3 border-b border-border/30 hover:bg-primary/5 transition-colors rounded px-2 -mx-2">
            ...
            <div className="flex justify-between items-center py-3 border-b border-border/30 hover:bg-primary/5 transition-colors rounded px-2 -mx-2">
              ...
              <span className="font-bold text-lg bg-gradient-to-r from-primary to-purple-600 bg-clip-text text-transparent">~{totalImages} images</span>
            </div>
            ...
            <div className="flex justify-between items-center py-3 hover:bg-emerald-500/5 transition-colors rounded px-2 -mx-2">
              <span className="text-sm text-muted-foreground flex items-center gap-1.5 font-medium">
              ...
              <span className="font-bold text-emerald-600 flex items-center gap-1">
                {estimatedCost}
                {estimatedCost === 'Free tier' && <span className="text-xs px-2 py-0.5 bg-emerald-500/10 border border-emerald-500/20 rounded-full">✓</span>}
              </span>
            </div>
          </div>
        </div>
